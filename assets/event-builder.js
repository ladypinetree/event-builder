...
define("event-builder/templates/components/event-index", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "pjcP10CG", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"container\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"event\",[\"get\",[\"event\"]]],null,1],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"edit\",[\"get\",[\"event\"]]],[[\"class\"],[\"btn btn-info btn-s glyphicon-pencil\"]],0],[\"text\",\"\\n  \"],[\"open-element\",\"button\",[]],[\"static-attr\",\"class\",\"btn btn-danger btn-s\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"deleteEvent\"]],[\"flush-element\"],[\"text\",\"Delete\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\" Edit\"]],\"locals\":[]},{\"statements\":[[\"append\",[\"unknown\",[\"event\",\"eventTitle\"]],false]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "event-builder/templates/components/event-index.hbs" } });
});
